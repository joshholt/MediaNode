/*globals init load populate up clickDir clickFile addToPlaylist addAll play next previous*/
var root      = "/f/",
...
function addToPlaylist(f, eoo) {
	...
	var $d = $('<a></a>').text(f.name).data('file', f).data('path', mediaRoot + f.path).addClass(eoo)
		.appendTo($p)
